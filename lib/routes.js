...
module.exports = ({ cache, config }) => {
  ...
  exports.overview = (req, res) => {
    // get.timelin.app is a download/update endpoint, not a landing page. Anyone
    // who hits the root gets sent to the branded download page rather than
    // Hazel's default overview UI. The functional routes (/download/*,
    // /update/*) are unaffected.
    res.writeHead(302, {
      Location: 'https://timelin.app/download'
    })
    res.end()
  }
